...
class KnowledgeListData {
  ...
  KnowledgeListData.fromJson(dynamic json) {
    if (json is List) {
      json.forEach((e) {
        list?.add(KnowledgeItemData.fromJson(e));
      });
    }
  }
}
...
class KnowledgeItemData {
  KnowledgeItemData({
    ...
    String? author,
    List<KnoledgeChildren>? children,
    num? courseId,
    String? cover,
    String? desc,
    num? id,
  ...
  KnowledgeItemData.fromJson(dynamic json) {
    ...
    if (json['children'] != null) {
      ...
      json['children'].forEach((v) {
        _children?.add(KnoledgeChildren.fromJson(v));
      });
    }
  ...
  String? _author;
  List<KnoledgeChildren>? _children;
  num? _courseId;
  String? _cover;
  String? _desc;
  num? _id;
  ...
  List<KnoledgeChildren>? get children => _children;
...
class KnoledgeChildren {
  ...
  KnoledgeChildren.fromJson(dynamic json) {
    if (json['articleList'] != null) {
      _articleList = [];
      json['articleList'].forEach((v) {
        _articleList?.add(v);
